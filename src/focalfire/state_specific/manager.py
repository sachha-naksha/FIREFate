"""Entry point for **FocalFireStateSpecific** -- regulation of a fixed cell state.

``StateSpecificManager`` runs the same over-representation primitive as the
Temporal module (:func:`focalfire.base.enrichment.calculate_tf_episodic_enrichment`)
