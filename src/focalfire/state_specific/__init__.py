"""**FocalFireStateSpecific** -- what separates two fixed cell states.
...
from focalfire.state_specific._enrichment import (
    COLOR_MAP,
...
from focalfire.state_specific.manager import StateSpecificManager
