"""**FocalFireTemporal** -- how TF regulation changes along a trajectory.
...
from focalfire.temporal._align import AlignTimeScales, plot_main_trajectory_nodes
from focalfire.temporal._chromatin import (
    SmoothedCurvesChromatin,
    plot_chromatin_tf_dynamics,
    plot_score_vs_count_subplots,
)
from focalfire.temporal._curves import (
    SmoothedCurvesGRN,
...
from focalfire.temporal._episodes import (
    EpisodeDynamics,
...
from focalfire.temporal._source import TFForceSource
from focalfire.temporal._reductions import (
    abs_max_force,
    mean_force,
    softmax_peak,
)
from focalfire.temporal._phases import (
    BindingPhases,
    ForceWavePhases,
    RegulatoryPhases,
...
from focalfire.temporal._states import (
    StateFrequency,
    plot_state_composition_bars,
    plot_state_composition_curves,
    plot_state_extrema,
)
from focalfire.temporal._validation import (
    TFForceValidation,
...
from focalfire.temporal._waves import (
    TFForceWaves,
    cluster_heatmap,
    plot_force_by_tf,
    plot_force_heatmap,
...
from focalfire.temporal.manager import (
    TemporalManager,
    TrajectorySegments,
