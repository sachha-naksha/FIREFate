"""The behaviour every FIREFate module manager shares.

A manager is the entry point of a FIREFate module. It *composes* domain objects
...
class BaseManager:
    """Shared bookkeeping for :class:`~firefate.temporal.TemporalManager` and friends.
